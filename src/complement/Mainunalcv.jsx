...
const Mainunalcv = () => {
    return (
        <div className="gap-10 flex flex-col md:flex-row items-center justify-center mt-20 mb-20 md:mb-0">

            <div className="w-full md:w-1/2 flex justify-center">
                <img
                    src="/img/min.jpg"
                    alt="Unalcv"
                    className="rounded-xl w-80 h-80 object-cover cursor-target hover:scale-105 hover:skew-x-5 hover:skew-y-6  duration-300 ease-in-out shadow-lg"
                />
            </div>
